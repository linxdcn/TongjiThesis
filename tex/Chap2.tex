...
\begin{figure}[htbp!] 
    \centering 
    \begin{tabular}{c} 
        \includegraphics[width=0.6\textwidth]{chap2/tsi-statistics-sett.eps} \\ 
        (a)~相对沉降${sett}_{a}$统计 \\
        \includegraphics[width=0.6\textwidth]{chap2/tsi-statistics-settd.eps} \\ 
        (b)~差异沉降$set{{t}_{d\_a}}$统计 \\
        \includegraphics[width=0.6\textwidth]{chap2/tsi-statistics-cov.eps} \\ 
        (c)~收敛变形${cov}_{a}$统计 \\
    \end{tabular}
...
\begin{figure}[htbp!] 
    \centering 
    \begin{tabular}{c} 
        \includegraphics[width=0.8\textwidth]{chap2/triangle-except-leakage.eps} \\ 
        (a)~${sett}_{a}$-$set{{t}_{d\_a}}$-$cov_a$ \\
        \includegraphics[width=0.8\textwidth]{chap2/triangle-except-conv.eps} \\ 
