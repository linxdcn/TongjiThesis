...
\begin{figure}[htb!] 
    \centering 
    \begin{tabular}{cc} 
        \includegraphics[width=0.48\textwidth]{chap2/tsr-setta.eps} & \includegraphics[width=0.48\textwidth]{chap2/tsr-settr.eps}\\ 
        (a)~TSR-${sett}_{a}$ & (b)~TSR-$set{{t}_{d\_a}}$\\
        \includegraphics[width=0.48\textwidth]{chap2/tsr-setta.eps} & \includegraphics[width=0.48\textwidth]{chap2/tsr-leakge.eps}\\ 
        (c)~TSR-${cov}_{a}$ & (d)~TSR-${d}_{l}$\\
        \includegraphics[width=0.48\textwidth]{chap2/tsr-spall.eps} & \includegraphics[width=0.48\textwidth]{chap2/tsr-crack.eps}\\ 
        (e)~TSR-$d_s$ & (f)~TSR-$d_c$\\
    \end{tabular}
    \caption{TSR与观测变量关系图} 
