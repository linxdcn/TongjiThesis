...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{chap2/sett-shear.pdf}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=1.0\textwidth]{chap2/tsi-map.jpg}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=1.0\textwidth]{chap2/tsi-preprocess.jpg}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=1.0\textwidth]{chap2/tsi-interpolation.jpg}
