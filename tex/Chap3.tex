...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.75\textwidth]{chap3/svar4.pdf}
    \caption{SVAR4模型结果}
    \label{fig:SVAR4模型结果}
\end{figure}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.75\textwidth]{chap3/svar5.pdf}
    \caption{SVAR5模型结果}
    \label{fig:SVAR5模型结果}
\end{figure}
