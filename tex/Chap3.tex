...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.9\textwidth]{chap3/concept.pdf}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=1.0\textwidth]{chap3/time-series-conclusion.pdf}
    \caption{时间序列模型分类}
    \label{fig:时间序列模型分类}
\end{figure}
...
自回归模型（潘红宇，\citeyear{cryer2011时间序列分析及应用}）就是用自身做回归变量，对于$p$阶自回归序列$\left\{ {{Y}_{t}} \right\}$满足方程：
\begin{align}
  \label{equ:AR1}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.65\textwidth]{chap3/time-series-process.pdf}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.62\textwidth]{chap3/var-process.pdf}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.7\textwidth]{chap3/water-table.eps}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.7\textwidth]{chap3/svar4.pdf}
    \caption{SVAR4模型结果}
    \label{fig:SVAR4模型结果}
\end{figure}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.7\textwidth]{chap3/svar5.pdf}
    \caption{SVAR5模型结果}
    \label{fig:SVAR5模型结果}
\end{figure}
...
\begin{figure}[htb!] 
    \centering 
    \begin{tabular}{c} 
        \includegraphics[width=1.0\textwidth]{chap3/tsi-history.eps} \\ 
        (a)~1号线不同年份TSI（部分） \\
        \includegraphics[width=1.0\textwidth]{chap3/tsi-history2.eps} \\ 
        (b)~1号线不同里程TSI（部分） \\
    \end{tabular}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=1.0\textwidth]{chap3/sett-2018.eps}
